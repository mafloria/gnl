            ...
            <div class="gnc-gasoducto-landscape landscape-section"  style="display: none">
                <div class="landscape-top">
                    ...
                    <div class="group-animated animatedParent" data-appear-left-offset='-700'  data-sequence='200'>
                         <div id="txt-wrap-1" class="txtWrap1 animated fadeInLeftShort" data-id="1">
                             <div class="txt-wrap-cntr">
                                 <div id="icon-2" class="icon3 animated fadeInLeftShort" data-id="2"></div> 
                                 <p class="txt-box1 animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->process->fuentes_gnc_box_op1; ?></p>   
                             </div>
 
                         </div>
                         <p id="txt-0" class="txtInfo animated fadeInLeftShort" data-id="4"><?php echo $texts->gasoducto->process->fuentes_gnc_box_titulo; ?></p>
                     </div> 
                     
                     <div class="group-animated animatedParent" data-appear-left-offset='-700'  data-sequence='300'>
                             <h2 id="h2-1" class="h2-title-box animated fadeInLeftShort" data-id="1"><?php echo $texts->gasoducto->top_titles->estacion_madre; ?></h2>
                     </div>
                 ...
                 <div class="landscape-bottom">
                     ...
                     <div class="group-animated animatedParent"  data-appear-left-offset='-1000'  data-sequence='300'> 
                        <h3 id="h3-1" class="title-green animated fadeInLeftShort" data-id="1"><?php echo $texts->gasoducto->road_info->gasoducto_virtual; ?></h3>
                        <div id="arrow-0" class="red-arrow animated fadeInLeftShort" data-id="2"></div>
                    </div>  
                  
                    <div class="group-animated animatedParent"  data-appear-left-offset='-1200'  data-sequence='300'>   
                        <h3 id="h3-2" class="title-h3 animated fadeInLeftShort" data-id="1"><?php echo $texts->gasoducto->road_info->secador; ?></h3>
                        <div id="warning-0" class="warning-icon animated fadeInLeftShort" data-id="2"></div>
                        <p id="txt-1" class="txtInfo animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->alert_messages->a1_secador; ?></p>
                    </div>
 
                    <!--elementos landscape bottom 2 --> 
                    <div class="group-animated animatedParent"  data-appear-left-offset='-1650'  data-sequence='300'>                       
                        <h3 id="h3-4" class="title-green animated fadeInLeftShort" data-id="1"><?php echo $texts->gasoducto->road_info->gasnatural; ?></h3>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-1750'  data-sequence='300'>
                        <h3 id="h3-5" class="title-h3 animated fadeInLeftShort" data-id="1"><span class="numeracion">1</span><?php echo $texts->gasoducto->process->p1_paquete_compresion; ?></h3>
                        <p id="txt-2" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->process->p1_paquete_compresion_desc; ?></p>
                    </div>
 
                    <div class="group-animated animatedParent"  data-appear-left-offset='-2400'  data-sequence='300'>                       
                        <h3 id="h3-6" class="title-green animated fadeInLeftShort" data-id="1"><?php echo $texts->gasoducto->road_info->gasnatural_comprimido; ?></h3>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-7400'  data-sequence='300'>
                        ...
                        <p id="txt-8" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->alert_messages->a1_mat_b; ?></p>
                        <p id="txt-9" class="txtInfo animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->alert_messages->a1_mat_b2; ?></p>
                    </div>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-8200'  data-sequence='300'>
                        ...
                        <p id="txt-10" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->process->p4_centro_consumo_desc; ?></p>
                    </div>
                    <div class="group-animated animatedParent"  data-appear-left-offset='-8600'  data-sequence='300'>
                        ...
                        <p id="txt-11" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->alert_messages->a2_intercambio_reconexion; ?></p>
                    </div>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-10100'  data-sequence='300'>
                        ...
                        <p id="txt-12" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->process->p5_depositado_pad_desc; ?></p>
                    </div>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-10450'  data-sequence='300'>
                        ...
                        <p id="txt-13" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->process->p6_gas_red_tuberias_desc; ?></p>
                    </div>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-10900'  data-sequence='300'>
                        ...
                        <h3 id="h3-14" class="title-h3 animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->alert_messages->a3_suministro_continuo_titulo; ?></h3>
                        <p id="txt-14" class="txtInfo animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->alert_messages->a3_suministro_continuo_desc; ?></p>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-11000'  data-sequence='300'>
                        ...
                        <h3 id="h3-17" class="title-h3 animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->road_info->usinas; ?></h3>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-11100'  data-sequence='300'>
                        ...
                        <h3 id="h3-22" class="title-h3 animated fadeInLeftShort" data-id="4"><?php echo $texts->gasoducto->road_info->comunidades_aisladas; ?></h3>
                    ...
                    <!--elementos landscape bottom 10 -->
                     <div class="group-animated animatedParent"  data-appear-left-offset='-11500'  data-sequence='300'>
                        ...
                        <h3 id="h3-16" class="title-h3 animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->road_info->minas_plantas; ?></h3>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-12100'  data-sequence='300'>
                        ...
                        <h3 id="h3-18" class="title-h3 animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->road_info->centros_turisticos; ?></h3>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-12150'  data-sequence='300'>
                        ...
                        <p id="txt-15" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->alert_messages->a4_sistema_recompresion_desc; ?></p>
                    </div>
                    ...
                    <div class="group-animated animatedParent"  data-appear-left-offset='-12600'  data-sequence='300'>
                        ...
                        <h3 id="h3-19" class="title-h3 animated fadeInLeftShort" data-id="3"><?php echo $texts->gasoducto->road_info->estaciones_servicio; ?></h3>
                    ...
                    <p id="txt-16" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->process->p7_trailer_vst_a_estacionmadre_desc; ?></p>
                    </div>

                    <!--elementos landscape bottom 12 -->
                    <div class="group-animated animatedParent"  data-appear-left-offset='-15000'  data-sequence='300'>
                        <h3 id="h3-21" class="title-h3 animated fadeInLeftShort" data-id="1"><span class="numeracion">8</span><?php echo $texts->gasoducto->process->p8_plataformas_pac; ?></h3>
                        <p id="txt-17" class="txtInfo animated fadeInLeftShort" data-id="2"><?php echo $texts->gasoducto->process->p8_plataformas_pac_desc; ?></p>
                    </div>
                    ...
                    <div class="group-animated animatedParent menu-circles-icons-end"  data-appear-left-offset='-15200'  data-sequence='300'>
                        ...
                        <a id="continue-yacimiento-process" class="view-process continue-process yacimiento-menu-btn-<?php echo $lang; ?> animated fadeInLeftShort" href="javascript:void(0);" data-id="3"></a>
                    </div>

                     <!--main image-->
                     <img  id="bgimage-gasoducto" class="main-landscape-image" src="assets/images/gnc-gasoducto-landscape-main-img-<?php echo $lang; ?>.png">
                     <!--main image-->
                </div>
